...
### Added
- `Breaker#closed?`, `Breaker#open?`, `Breaker#half_open?` state predicates — idiomatic Ruby alternatives to comparing `breaker.state` against the `Circuit::State` symbols
...
### Added
- `Breaker#trip!` administrative method to force the circuit into the open state
